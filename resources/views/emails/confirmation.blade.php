...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <td style="background:#09090f;padding:0;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="padding:28px 36px;">
        <tr>
          ...
          <td align="right">
            <span style="background:rgba(212,175,55,0.15);border:1px solid rgba(212,175,55,0.3);color:#D4AF37;font-size:11px;font-weight:600;padding:4px 12px;border-radius:20px;">✓ Confirmé</span>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td style="padding:36px;">
      ...
      <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#1a1a1a;">Votre rendez-vous est confirmé !</h1>
      <p style="margin:0 0 28px;color:#6b7280;font-size:15px;">
        Bonjour <strong style="color:#1a1a1a;">{{ $rdv->client->name ?? 'cher client' }}</strong>, voici le récapitulatif de votre réservation chez L'ARTISTO.
      </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="50%" style="padding-bottom:16px;">
                  ...
                  <span style="font-size:16px;font-weight:700;color:#B8860B;">{{ substr($rdv->heure, 0, 5) }}</span>
                </td>
              </tr>
              <tr>
                <td width="50%">
                  <span style="display:block;font-size:11px;text-transform:uppercase;letter-spacing:0.8px;color:#9ca3af;margin-bottom:4px;">Coiffeur</span>
